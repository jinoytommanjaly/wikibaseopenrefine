...
# https://shira.wikibase.cloud/wiki/Special:AllPages?from=&to=&namespace=120
...
fallback_image_url = 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Rothschild_miscellany_dancing.jpg/320px-Rothschild_miscellany_dancing.jpg'

# Alt text of the fallback image
fallback_image_alt = 'shira.cloud logo'
